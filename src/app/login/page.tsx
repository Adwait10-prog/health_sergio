  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <form method="post" action="/api/login" style={{
        ...
        <p style={{ fontSize: 12.5, color: "var(--text-3)", margin: "0 0 18px" }}>Enter your password to continue.</p>
        <input type="hidden" name="next" value={safeNextPath(next)} />
        <input
          type="password" name="password" autoComplete="current-password" autoFocus required
          style={{
        ...
        />
        {e && <p style={{ fontSize: 12, color: "var(--warn)", margin: "8px 0 0" }}>Wrong password.</p>}
